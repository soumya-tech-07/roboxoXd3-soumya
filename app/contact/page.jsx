            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-gray-900 mb-1 tracking-wide">EMAIL</h3>
                    <a
                      href="mailto:hello@retrolouve.com"
                      className="text-xs sm:text-sm text-gray-600 hover:text-brand transition-colors"
                    >
                      hello@retrolouve.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-gray-900 mb-1 tracking-wide">PHONE</h3>
                    <a
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-gray-900 mb-1 tracking-wide">ADDRESS</h3>
                ...
                <div className="flex items-start gap-4 pt-4">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-gray-900 mb-3 tracking-wide">FOLLOW US</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={6}
                  className="w-full px-4 py-3 border border-gray-300 text-sm text-gray-900 focus:outline-none focus:border-brand transition-colors resize-none"
